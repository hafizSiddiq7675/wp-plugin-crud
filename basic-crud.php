 ...
 * Plugin URI: https://www.rajtechnologies.com
 * Description: Prints "Hello World" in WordPress admin. 
 * Version: 0.0.1 
 * Author: Fahad Khan
 * Author URI: https://bhargavraviya.github.io/bhargavraviya
 ...
 * License URI: http://www.gnu.org/licenses/gpl-2.0.txt */
 ...
 function crudAdminPage() {
   ...
   if (isset($_POST['newsubmit'])) {
     ...
     echo "<script>location.replace('admin.php?page=basic-crud/basic-crud.php');</script>";
   }
           ...
           foreach ($result as $print) {
             echo "
               <tr>
                 ...
                 <td width='25%'><a href='admin.php?page=basic-crud/basic-crud.php&upt=$print->user_id'><button type='button'>UPDATE</button></a> <a href='admin.php?page=basic-crud/basic-crud.php&del=$print->user_id'><button type='button'>DELETE</button></a></td>
               </tr>
             ";
           }
         ?>
           ...
           <tbody>
             <form action='' method='post'>
               <tr>
                 ...
                 <td width='25%'><button id='uptsubmit' name='uptsubmit' type='submit'>UPDATE</button> <a href='admin.php?page=basic-crud/basic-crud.php'><button type='button'>CANCEL</button></a></td>
               </tr>
             </form>
           </tbody>
         </table>";
